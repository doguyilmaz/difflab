export function Footer() {
  return (
    <footer className="mt-auto border-t border-border py-4">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 text-xs text-text-muted">
        <span>
          Built by{" "}
          <a
            href="https://github.com/doguyilmaz"
            target="_blank"
            rel="noopener"
